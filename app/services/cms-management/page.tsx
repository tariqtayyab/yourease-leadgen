...
const whyChooseCards: WhyChooseCard[] = [
  {
    ...
    description:
      'Yourease will provide the Webflow platform along with the full CMS setup, covering all details of content posting and management so your team hits the ground running.',
    variant: 'lime',
  },
  {
    title: 'Access control',
    description:
      'Custom roles and permissions for your team to access the CMS accordingly — so the right people can post, update, and manage without stepping on each other.',
    variant: 'blue',
  },
  {
    title: 'Content workflow',
    description:
      'Create landing pages, run a streamlined workflow, publish blogs with ease, and roll out new offers — all from one place, without touching a single line of code.',
    variant: 'lime',
  },
  {
    title: 'One location management',
    description:
      'With one CMS, you no longer need any other tool or platform to manage your website. Everything is centralized so you can administrate with full confidence.',
    variant: 'blue',
  },
];
...
const snapCards: SnapCard[] = [
  {
    title: 'CMS + Webflow management',
    description:
      'CMSs are built for ease — clear dashboards, simple shortcuts, no code confusion, just well-integrated interfaces that let your team move fast. At Yourease, we set it all up so your content workflow is as smooth as your design.',
    stats: [
      { value: '25%', label: 'increase in output' },
      { value: '76%', label: 'team efficiency boost' },
    ],
    image:
      'https://cdn.prod.website-files.com/67ece9bf9a58e5528ea1455d/681789816b73f738faec9457_mo-uEsjoCzALaU-unsplash.avif',
    variant: 'dark',
  },
  {
    title: "You're not a coder, you don't have to be",
    description:
      "Not everyone can handle content management — and they shouldn't have to. Yourease sets up a centralized CMS built with your whole team in mind, so anyone with credentials can make updates instead of waiting on a developer.",
    stats: [
      { value: '500M', label: 'reach' },
      { value: '30+', label: 'platforms integrated' },
    ],
    image:
      'https://cdn.prod.website-files.com/67ece9bf9a58e5528ea1455d/681789816b73f738faec944d_pexels-francesco-ungaro-1326999.avif',
    variant: 'light',
  },
  {
    title: 'We give you control to operate',
    description:
      'No more waiting for the developer to show up. No more lags, no more delays. With a perfect CMS setup, you can operate on your own and control exactly who gets access.',
    stats: [
      { value: '200%', label: 'faster publishing' },
      { value: '76k', label: 'content pieces managed' },
    ],
    image:
      'https://cdn.prod.website-files.com/67ece9bf9a58e5528ea1455d/681789816b73f738faec9444_pexels-mo-8347499.avif',
    variant: 'dark',
  },
];
...
const portfolioItems: PortfolioItem[] = [
  {
    ...
    title: 'LOOM Fashion',
    category:
      'Loom pioneers sustainable fashion technology by bridging customers with trusted designers who transform existing wardrobes into thoughtfully reimagined pieces.',
    image:
      'https://cdn.prod.website-files.com/67fce3ecde451a83c42218ab/696beb57d96293529da18ccd_Loom-Multiple-Screens.jpeg',
  ...
  },
  {
    ...
    image:
      'https://cdn.prod.website-files.com/67fce3ecde451a83c42218ab/67fee7ca741c4c8caea2ade3_EHTHR00222_7.webp',
  ...
  },
  {
    ...
    image:
      'https://cdn.prod.website-files.com/67fce3ecde451a83c42218ab/67fee6fa5d35337ddee186a0_Restaurant-Payment.jpg',
  ...
  },
  {
    ...
    image:
      'https://cdn.prod.website-files.com/67fce3ecde451a83c42218ab/67fee6812cca1c0ab8e7f8a3_copy-of-0p4a2062a-w1200h600.jpg',
  ...
  },
  {
    ...
    image:
      'https://cdn.prod.website-files.com/67fce3ecde451a83c42218ab/67fee620111834fa54724ff8_born-menswear.jpg',
  ...
  },
  {
    ...
    image:
      'https://cdn.prod.website-files.com/67fce3ecde451a83c42218ab/67fee5d0d7ab3afccd659824_The-ultimate-eBike-conversion-system.jpg',
    href: '/projects/arcc-bikes',
  },
];

// ─── Sub-components (identical structure to Branding page) ───────────────────
    ...
    <div className="bg-[#3665fb] py-3 md:py-4 overflow-hidden">
      <div className="flex whitespace-nowrap animate-marquee-text">
        {[...Array(6)].map((_, i) => (
          ...
          >
            // Unleashing the power of CMS MANAGEMENT
          </span>
        ))}
      </div>
...
const WhyChooseCard: React.FC<WhyChooseCard & { index: number }> = ({
  title,
  description,
  variant,
  index,
  ...
  const baseClasses =
    'rounded-full flex flex-col items-center justify-center p-6 md:p-8 text-center transition-transform hover:scale-105';
    ...
    >
      ...
      <p
        className={`text-xs md:text-sm lg:text-base leading-relaxed ${
          isLime ? 'text-gray-700' : 'text-gray-200'
        }`}
      >
        {description}
      </p>
...
const PortfolioCard: React.FC<PortfolioItem> = ({ title, category, image, href }) => {
  return (
    <Link href={href} className="group block break-inside-avoid mb-4 md:mb-6">
        ...
        <div className="aspect-[4/3] relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <div className="bg-[#d1fd68] rounded-full w-12 h-12 md:w-16 md:h-16 flex items-center justify-center">
              <span className="text-gray-900 font-semibold text-xs md:text-sm uppercase tracking-wider">
                View
              </span>
            </div>
          </div>
      ...
      <h3 className="text-lg md:text-xl font-bold uppercase font-['TT_Trailers'] mb-1 md:mb-2">
        {title}
      </h3>
      <p className="text-gray-500 text-xs md:text-sm font-['GeneralSans'] leading-relaxed">
        {category}
      </p>
    </Link>
  );
...
export default function CmsManagementPage(): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>CMS Management | Yourease</title>
        <meta
          name="description"
          content="Yourease helps you take full control of your content with a centralized CMS — no developer needed, no delays, just clean and simple content management."
        />
          ...
          <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 xl:px-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="mt-4 md:mt-8 text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#303030] font-['GeneralSans']">
                  We help you control your content so that you can manage your audience
                </p>
                <button
                ...
                >
                  <span className="font-['TT_Trailers'] text-xl md:text-3xl tracking-wide">
                    LET&apos;S TALK
                  </span>
                  <Image
                    src="/images/service.svg"
                    ...
                    width={12}
                    height={16}
                    className="mb-1 w-3 h-4 md:w-3 md:h-4"
                  />
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
              <div>
                <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-5 font-['TT_Trailers'] text-[#000000] leading-tight">
                  Managing content with a centralized framework
                </h2>
                <p className="text-[#474747] text-base md:text-lg mb-6 md:mb-8 leading-relaxed font-['GeneralSans']">
                  Yourease integrates a content management system for your team to work around content
                  seamlessly. A centralized control provides authority and quick access — so you spend
                  less time managing tools and more time connecting with your audience. Built for{' '}
                  <Link href="/service/webflow-development" className="text-[#3665fb] hover:underline">
                    Webflow development
                  </Link>
                  ,{' '}
                  <Link href="/service/strategy-consultation" className="text-[#3665fb] hover:underline">
                    strategy consultation
                  </Link>
                  , and teams that want to move fast without breaking things.
                </p>
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 font-['GeneralSans']">
                        No developer needed
                      </h3>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Nobody likes to wait when they have content ready to publish. With Yourease&apos;s
                        CMS services, your wait is over — publish on your schedule, not the
                        developer&apos;s.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Your content is how you connect with your audience. Yourease empowers you with a
                        streamlined CMS to manage your content smartly — from blog posts to landing pages,
          ...
          <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 xl:px-20">
            <div className="max-w-2xl mb-8 md:mb-16">
              ...
              <p className="text-gray-600 text-base md:text-lg font-['GeneralSans']">
                Yourease lets you take control of your website with a CMS that is comprehensive, swift,
                and user-friendly.
              </p>
            </div>

            {/* Desktop — overlapping animated cards */}
                ...
                >
                  ...
                  <p
                    className={`text-xs leading-relaxed ${
                      card.variant === 'lime' ? 'text-gray-700' : 'text-gray-200'
                    }`}
                  >
                    {card.description}
                  </p>
          ...
          <div className="sticky top-0 h-screen w-full">
            <div className="text-center px-4 pt-8 md:pt-13 pb-4 md:pb-8 bg-white">
              <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-['TT_Trailers']">
                Process that actually <em>works</em>
              </h2>
              <p className="text-gray-60 text-md md:text-base lg:text-lg font-['GeneralSans'] mt-2">
                Make unclear content milestones and missed updates a thing of the past.
              </p>
            </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
                          {card.stats.map((stat, i) => (
                            <div key={i}>
                              ...
                              <div className="text-sm md:text-sm uppercase">{stat.label}</div>
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="w-full sm:w-[220px] md:w-[250px]">
                          ...
                          >
                            <span className="font-['TT_Trailers'] text-2xl md:text-3xl tracking-wide">
                              LET&apos;S TALK
                            </span>
                            <Image
                              src="/images/service.svg"
