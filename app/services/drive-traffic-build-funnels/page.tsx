...
const whyChooseCards: WhyChooseCard[] = [
  {
    ...
    description: "Yourease identifies high-ROI channels and tailors a mix of organic and paid strategies to bring qualified traffic that actually converts, not just random visitors.",
    variant: 'lime',
  },
  {
    title: 'Build strategic funnels',
    description: 'We design customer journeys that guide prospects step by step—from awareness to decision—ensuring no lead falls through the cracks.',
    variant: 'blue',
  },
  {
    title: 'Convert traffic into revenue',
    description: 'Driving traffic is only half the battle. We optimize every touchpoint to turn visitors into loyal customers, maximizing your return on investment.',
    variant: 'lime',
  },
  {
    title: 'Data-driven optimization',
    description: 'We continuously analyze performance metrics and refine your funnels based on real data, so your campaigns get smarter and more effective over time.',
    variant: 'blue',
  },
];
...
const snapCards: SnapCard[] = [
  {
    title: 'The combination you need',
    description: 'Driving traffic to your website isn’t enough. Yourease builds funnels so that your customers go through an entire process—by the time you close, they are meant to stay forever. At each level, we extend a sense of curiosity between you and your customer, which fuels trust and ultimately leads to sales.',
    stats: [
  ...
  {
    title: 'Traffic meets funnel architecture',
    description: 'Yourease understands that only bringing people to the website won’t make a difference—your audience can bounce off anytime. That’s where funnel architecture comes in. We develop a whole process to ensure the audience leads to final conversions.',
    stats: [
  ...
  {
    title: 'Sales above all',
    description: 'A business without sales is a boat without a rudder. At Yourease, nothing goes out without aligning with the main strategy we build for you. This keeps everyone on the same page, induces consistency, and increases organic traffic, funnel movement, and conversions.',
    stats: [
    ...
    <div className="bg-[#3665fb] py-3 md:py-4 overflow-hidden">
      <div className="flex whitespace-nowrap animate-marquee-text">
        {[...Array(6)].map((_, i) => (
          ...
          >
            // Turn traffic into conversions with strategic funnels
          </span>
        ))}
      </div>
...
// Main Page Component
export default function DriveTrafficPage(): JSX.Element {
...
useEffect(() => {
  ...
  return (
    <>
      <Head>
        <title>Drive Traffic & Build Funnels | Yourease - Growth Agency</title>
        <meta name="description" content="Turn visitors into loyal customers with Yourease's traffic and funnel strategies. Drive organic growth and build conversion-optimized funnels." />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="mt-4 md:mt-8 text-lg sm:text-xl md:text-2xl lg:text-4xl whitespace-normal md:whitespace-nowrap text-[#303030] font-['GeneralSans']">
                  We help you strategically so you can grow organically
                </p>
                <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
              <div>
                <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-5 font-['TT_Trailers'] text-[#000000] leading-tight">
                  Grow organically and boost your conversions.
                </h2>
                <p className="text-[#474747] text-base md:text-lg mb-6 md:mb-8 leading-relaxed font-['GeneralSans']">
                  Attract the audience your website deserves. Let your audience go through the funnels and have an actionable roadmap ready to close the deal. Yourease combines strategic traffic generation with proven funnel architecture to turn visitors into loyal customers.
                </p>
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 font-['GeneralSans']">Traction into traffic</h3>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        We believe in traction and we use it to bring in the organic and relevant traffic your website deserves.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 font-['GeneralSans']">Funnel movement</h3>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        We build funnels for your audience to ensure they go through a process before they make the final purchase.
                      </p>
                    </div>
                  </div>
                </div>
  ...
  <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 xl:px-20">
    <div className="max-w-2xl mb-8 md:mb-16">
      <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-3 md:mb-4 font-['TT_Trailers'] text-[#000000] leading-tight">
        How Yourease structures your growth
      </h2>
      <p className="text-gray-600 text-base md:text-lg font-['GeneralSans']">
        We just don’t settle for traffic—we guide your audience through a funnel for them to acknowledge each level before sales.
      </p>
    </div>
...
>
  ...
  <div className="sticky top-0 h-screen w-full">
    ...
    <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-['TT_Trailers'] ">
      Turn Traffic Into Conversions with Sales Funnels
    </h2>
    <p className="text-gray-60 text-md md:text-base lg:text-lg font-['GeneralSans'] mt-2">
      Drive traffic with content and guide every visitor to buy.
    </p>
  </div>
