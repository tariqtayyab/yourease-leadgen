...
const whyChooseCards: WhyChooseCard[] = [
  {
    ...
    description: "Yourease's team knows that without a clear roadmap, success is just luck. We dive deep into your business to uncover insights that shape a winning strategy tailored to your unique goals.",
    variant: 'lime',
  },
  {
    title: 'Data-driven decisions',
    description: 'We never rely on guesswork. Instead, Yourease leverages analytics and market research to guide every consultation, ensuring your decisions are backed by real insights, not assumptions.',
    variant: 'blue',
  },
  {
    title: 'Actionable frameworks',
    description: 'Strategy without execution is just a dream. We build practical, step-by-step frameworks that turn plans into measurable results, so you can see progress every step of the way.',
    variant: 'lime',
  },
  {
    title: 'Ongoing partnership',
    description: 'We don’t just deliver a strategy and walk away. Yourease stays by your side, offering continuous consultation and refinement to ensure your business adapts and thrives in changing markets.',
    variant: 'blue',
  },
];
...
const snapCards: SnapCard[] = [
  {
    title: 'Beyond surface-level advice',
    description: 'Our consultants at Yourease go deep into your operations, culture, and market to uncover opportunities others miss. We don’t just give advice—we build solutions that drive real growth.',
    stats: [
  ...
  {
    title: 'Strategy is our craft, results are our signature',
    description: 'We reject cookie-cutter approaches. Every strategy we design is custom-built for your vision, combining creative thinking with analytical rigor to deliver outcomes that matter.',
    stats: [
  ...
  {
    title: 'Collaboration that drives clarity',
    description: 'At Yourease, we believe the best strategies emerge from genuine partnership. We work alongside you, not in a silo, ensuring every decision is aligned with your values and ambitions.',
    stats: [
    ...
    <div className="bg-[#3665fb] py-3 md:py-4 overflow-hidden">
      <div className="flex whitespace-nowrap animate-marquee-text">
        {[...Array(6)].map((_, i) => (
          ...
          >
            // Strategy that scales, consultation that delivers
          </span>
        ))}
      </div>
...
// Main Page Component
export default function StrategyConsultationPage(): JSX.Element {
...
useEffect(() => {
  ...
  return (
    <>
      <Head>
        <title>Strategy & Consultation | Yourease - Strategic Agency</title>
        <meta name="description" content="Transform your business with strategic clarity. Yourease offers expert consultation and actionable strategies that drive measurable growth." />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="mt-4 md:mt-8 text-lg sm:text-xl md:text-2xl lg:text-4xl whitespace-normal md:whitespace-nowrap text-[#303030] font-['GeneralSans']">
                  We consult with you, and we strategize for you
                </p>
                <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
              <div>
                <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-5 font-['TT_Trailers'] text-[#000000] leading-tight">
                  Make every move strategic with expert consultation.
                </h2>
                <p className="text-[#474747] text-base md:text-lg mb-6 md:mb-8 leading-relaxed font-['GeneralSans']">
                  Yourease stands for the strategy-first rule. We don&apos;t just make strategies—we execute them into actionable steps aligned perfectly with your goals. Through refined{' '}
                  ...
                  <Link href="/blogs/how-yourease-turns-strategy-into-scalable-results" className="text-[#3665fb] hover:underline">business strategy</Link>, we turn ideas into lasting impact.
                </p>
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 font-['GeneralSans']">Strategy-first rule</h3>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Most brands fail because they lack strategy. But we value strategy and diligently follow the strategy-first rule to make sure we have a game plan for you.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 font-['GeneralSans']">Consulting is comforting</h3>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Yes, Yourease offers brand consultation services to just sit and listen about what you feel about your product and what are the problems.
                      </p>
                    </div>
                  </div>
                </div>
  ...
  <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 xl:px-20">
    <div className="max-w-2xl mb-8 md:mb-16">
      <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-3 md:mb-4 font-['TT_Trailers'] text-[#000000] leading-tight">
        Yourease&apos;s strategic framework
      </h2>
      <p className="text-gray-600 text-base md:text-lg font-['GeneralSans']">
        We focus on giving your business the clarity and direction it needs to scale.
      </p>
    </div>
...
>
  ...
  <div className="sticky top-0 h-screen w-full">
    ...
    <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-['TT_Trailers'] ">
      Strategy never fails, and consultation is comfort
    </h2>
    <p className="text-gray-60 text-md md:text-base lg:text-lg font-['GeneralSans'] mt-2">
      We structure every element to procure a well-aligned strategy for you, and yes, we are good listeners too.
    </p>
  </div>
