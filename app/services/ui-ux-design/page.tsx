...
const whyChooseCards: WhyChooseCard[] = [
  {
    ...
    description: 'Full-page discussed and designed with clear structures that derive real conversions. We create comprehensive design systems that ensure consistency across your digital presence.',
    variant: 'lime',
  },
  {
    title: 'Mobile-first & responsive layouts',
    description: "Blushush's team never guesses; we command. So we actually design how things will look on a mobile screen and optimize it in sync with features.",
    variant: 'blue',
  },
  {
    title: 'UI/UX are humane',
    description: 'We want your audience to have a natural and effortless experience navigating your website. Blushush strives to create something that\'s humane and not over-the-top.',
    variant: 'lime',
  },
  {
    title: 'Organized development',
    description: 'With Figma, we operate with a smooth Webflow arrangement and development framework. We build interactive prototypes that let you experience your digital product before development begins.',
    variant: 'blue',
  },
];
...
const snapCards: SnapCard[] = [
  {
    title: 'Premium web design structures',
    description: 'Figma syncs well with premium web design structures. Something founders and creative personalities often look for. It is ideal for the pre-build stage and offers the ability to shape your brand designs accordingly.',
    stats: [
  ...
  },
  {
    ...
    description: 'Figma allows our teams to collaborate with you and make real-time changes along with other built-in features. Tending to static mockups, launching a personal brand, or getting ready for a Webflow build. Figma has got you covered with stunning and visually appealing design systems.',
    stats: [
  ...
  {
    title: 'Designs that work, visuals that attract',
    description: 'With Figma, everything fits in harmony, It makes design look easy. It is smooth, smart and most importantly clutter free. You don\'t need extensive knowledge to design screens and at the same time can contribute to the whole design and development process.',
    stats: [
    ...
    <div className="bg-[#3665fb] py-3 md:py-4 overflow-hidden">
      <div className="flex whitespace-nowrap animate-marquee-text">
        {[...Array(6)].map((_, i) => (
          ...
          >
            // Unleashing the power of FIGMA UI/UX
          </span>
        ))}
      </div>
...
// Main Page Component
export default function FigmaPage(): JSX.Element {
...
useEffect(() => {
  ...
  return (
    <>
      <Head>
        <title>Services | Yourease - Figma UI/UX Agency</title>
        <meta name="description" content="Transform your digital presence with expert Figma UI/UX design. We create stunning interfaces, design systems, and interactive prototypes that convert." />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="mt-4 md:mt-8 text-lg sm:text-xl md:text-2xl lg:text-4xl whitespace-normal md:whitespace-nowrap text-[#303030] font-['GeneralSans']">
                  Rookies use it as a design tool; we turn it into a brand studio
                </p>
                <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
              <div>
                <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-5 font-['TT_Trailers'] text-[#000000] leading-tight">
                  Design that speaks your power.
                </h2>
                <p className="text-[#474747] text-base md:text-lg mb-6 md:mb-8 leading-relaxed font-['GeneralSans']">
                  Blushush offers stunning interfaces and intuitive designs. Using Figma, we incorporate a clutter-free user experience that leads to better engagement and conversions. Through refined{' '}
                  ...
                  <Link href="/blogs/how-blushush-turns-brand-strategy-into-scalable-high-converting-webflow-websites" className="text-[#3665fb] hover:underline">design system</Link>, we turn ideas into lasting impressions.
                </p>
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 font-['GeneralSans']">Not deadlines but targets</h3>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Figma at Blushush has a completely new meaning and application. We only target to nail the design personification for your business.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 font-['GeneralSans']">We design to deliver</h3>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Blushush synonyms with clarity and confidence. Our creative team is inclined to work and strategically design to deliver quantifiable results.
                      </p>
                    </div>
                  </div>
                </div>
  ...
  <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 xl:px-20">
    <div className="max-w-2xl mb-8 md:mb-16">
      <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-3 md:mb-4 font-['TT_Trailers'] text-[#000000] leading-tight">
        Our approach to Figma
      </h2>
      <p className="text-gray-600 text-base md:text-lg font-['GeneralSans']">
        Create user interfaces and user experiences and test designs for your website, it's like an entire design powerhouse.
      </p>
    </div>
...
>
  ...
  <div className="sticky top-0 h-screen w-full">
    ...
    <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-['TT_Trailers'] ">
      No more boring web based graphics
    </h2>
    <p className="text-gray-60 text-md md:text-base lg:text-lg font-['GeneralSans'] mt-2">
      With Figma, you'll look sharper, brighter and aesthetically pleasing
    </p>
  </div>
