...
const whyChooseCards: WhyChooseCard[] = [
  {
    title: 'Webflow excellence',
    description: 'We build enterprise-grade Webflow sites with clean code architecture, scalable CMS structures, and lightning-fast performance. Every site is optimized for SEO and conversions from day one.',
    variant: 'lime',
  },
  {
    title: 'No-code innovation',
    description: "We leverage Webflow's visual development power combined with custom code when needed. This hybrid approach delivers complex functionality without the traditional development bottlenecks.",
    variant: 'blue',
  },
  {
    title: 'Server-first speed',
    description: 'We architect websites that load instantly. By leveraging modern server-side rendering, edge computing, and optimized asset delivery, we ensure your site feels immediate on every device.',
    variant: 'lime',
  },
  {
    title: 'Future-proof builds',
    description: 'Your website grows with your business. We build modular, component-based systems that make adding new features, pages, and integrations seamless—without rebuilding from scratch.',
    variant: 'blue',
  },
];
...
const snapCards: SnapCard[] = [
  {
    ...
    description: 'In 2026, speed is currency. A 1-second delay costs 7% in conversions. We engineer Webflow sites that load in under 2 seconds, with optimized images, clean code, and strategic use of modern hosting infrastructure. Your visitors never wait.',
    stats: [
  ...
  },
  {
    ...
    description: 'Micro-interactions boost engagement by 40%. We craft purposeful animations that guide users, provide feedback, and create memorable experiences. Every motion serves a function—never decoration for decoration\'s sake.',
    stats: [
      { value: '40%', label: 'engagement boost' },
      { value: '60%', label: 'faster perception' },
    ],
  ...
  },
  {
    ...
    description: 'Over 1 billion people worldwide have disabilities. We build WCAG-compliant websites that work for everyone—keyboard navigable, screen-reader friendly, and cognitively accessible. Compliance isn\'t an add-on; it\'s foundational to quality.',
    stats: [
      { value: '1B+', label: 'users served' },
...
useEffect(() => {
  ...
  return (
    <>
      <Head>
        <title>Services | Yourease - Web & App Development Agency</title>
        <meta name="description" content="Premium Webflow development agency building lightning-fast, scalable websites. We combine no-code innovation with custom engineering for exceptional digital experiences." />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="mt-4 md:mt-8 text-lg sm:text-xl md:text-2xl lg:text-4xl whitespace-normal md:whitespace-nowrap text-[#303030] font-['GeneralSans']">
                  Websites are first impressions; we make them sharp, visually stunning, and unforgettable
                </p>
                <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
              <div>
                <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-5 font-['TT_Trailers'] text-[#000000] leading-tight">
                  Engineering digital experiences that perform.
                </h2>
                <p className="text-[#474747] text-base md:text-lg mb-6 md:mb-8 leading-relaxed font-['GeneralSans']">
                  Blushush transforms Figma designs into living, breathing Webflow websites. We don't just build sites—we engineer performance machines that load instantly, convert relentlessly, and scale effortlessly. Through refined{' '}
                  <Link href="/service/strategy-consultation" className="text-[#3665fb] hover:underline">technical strategy</Link>,{' '}
                  <Link href="/service/seo-performance-optimization" className="text-[#3665fb] hover:underline">performance optimization</Link>, and{' '}
                  <Link href="/service/figma-ui-ux" className="text-[#3665fb] hover:underline">design implementation</Link>, we turn static mockups into revenue-generating assets.
                </p>
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 font-['GeneralSans']">Clean code architecture</h3>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        We follow "Client-First" naming conventions, semantic HTML, and organized class structures. Your site isn't just beautiful—it's maintainable, scalable, and built to Webflow Enterprise standards.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2 font-['GeneralSans']">CMS that empowers</h3>
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        We architect sophisticated CMS structures that let your marketing team publish, edit, and scale without touching code. Dynamic collections, relational databases, and custom fields—built for real business workflows.
                      </p>
                    </div>
                  </div>
                </div>
  ...
  <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 xl:px-20">
    <div className="max-w-2xl mb-8 md:mb-16">
      ...
      <p className="text-gray-600 text-base md:text-lg font-['GeneralSans']">
        We don't just build websites—we engineer digital infrastructure that powers your business growth.
      </p>
    </div>
...
>
  ...
  <div className="sticky top-0 h-screen w-full">
    ...
    <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-['TT_Trailers'] ">
      Speed is currency in 2026
    </h2>
    <p className="text-gray-60 text-md md:text-base lg:text-lg font-['GeneralSans'] mt-2">
      Every millisecond counts. We engineer performance that converts visitors into customers.
    </p>
  </div>
